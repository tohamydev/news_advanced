...
mixin _$HomeState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(TopHeadlinesResponse data) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(TopHeadlinesResponse data)? loaded,
...
abstract class _$$LoadedImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({TopHeadlinesResponse data});
}
...
class _$LoadedImpl<T> implements Loaded<T> {
  ...
  @override
  final TopHeadlinesResponse data;
...
abstract class Loaded<T> implements HomeState<T> {
  const factory Loaded(final TopHeadlinesResponse data) = _$LoadedImpl<T>;

  TopHeadlinesResponse get data;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<T, _$LoadedImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
